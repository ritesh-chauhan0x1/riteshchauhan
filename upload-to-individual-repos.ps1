# Quick Upload Script for Individual Repositories
...
Write-Host "⚠️ IMPORTANT: Make sure you've created ALL GitHub repositories first!" -ForegroundColor Yellow
...
foreach ($project in $projects) {
    ...
    if (Test-Path $project) {
        ...
        Write-Host "   ⚠️ Project directory not found: $project" -ForegroundColor Yellow
        $failed++
    }
